        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-start">
          ...
          <div className="animate-on-scroll">
            ...
            <div className="flex gap-3 mt-6">
              <img src={curso1} alt="Automaquillaje natural" className="w-[141px] h-[182px] object-cover rounded-sm" />
              <img src={curso2} alt="Automaquillaje glam" className="w-[141px] h-[182px] object-cover rounded-sm" />
            </div>
          </div>
